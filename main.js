...
const { getIngredients, getVanillaIngredients, getRecipePrice } = require('./utils')
...
async function main() {
  ...
  // vanillaIngredients = getVanillaIngredients(recipes.results[0], requiredPortions)

  // console.log(JSON.stringify(recipes.results[0], null, 4))
  // console.log(JSON.stringify(vanillaIngredients, null, 4))
